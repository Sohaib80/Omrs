      ...
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h2>DM SYSTEM</h2>
              <p>Register your self as a user</p>
...
<div class="form-group">
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15">Online DM Registration System @ 2021 <br>Designed & Devolpe By: Mudassir Khattak</p>
      </div><!-- signin-box -->
