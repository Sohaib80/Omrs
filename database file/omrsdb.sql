...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2021 at 04:59 PM
...
(1, 'Admin', 'admin', 1234567890, 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '2020-04-28 05:26:03');

-- --------------------------------------------------------

--
-- Table structure for table `tbldomicile`
--

CREATE TABLE `tbldomicile` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tbldomicile`
--

INSERT INTO `tbldomicile` (`id`, `RegistrationNumber`, `UserID`, `image`, `Name`, `FatherName`, `Province`, `Religion`, `Cast`, `DOB`, `MartialStatus`, `Address`, `RegDate`, `Status`, `Remark`) VALUES
(5, '983501557', 2, 'DSC_0214.JPG', 'Mudassir Ahmed', 'Abdul Wahid', 'Bachelor', 'Islam', 'Khattak', '03/15/1998', 'Bachelor', 'Khushal Khan Khattak University KARAK', '2021-06-22 09:45:34', 'Verified', 'done');
...
(2, 'Mudassir', 'Khattak', 1234567890, 'Karak', 'ee11cbb19052e40b07aac0ca060c23ee', '2020-05-02 10:46:08');
...
--
-- Indexes for table `tbldomicile`
--
ALTER TABLE `tbldomicile`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbldomicile`
--
ALTER TABLE `tbldomicile`
